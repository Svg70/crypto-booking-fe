...
if (!process.env.REACT_APP_WALLET_CONNECT_PROJECT_ID)
  throw new Error("`REACT_APP_WALLET_CONNECT_PROJECT_ID` env variable is missing.");
...
export const DEFAULT_PROJECT_ID = process.env.REACT_APP_WALLET_CONNECT_PROJECT_ID;
